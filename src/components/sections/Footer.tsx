  ...
  return (
    <footer className="bg-white border-t border-[rgba(5,61,202,0.1)] pt-16 pb-7 px-6 md:px-12">
      <div className="max-w-[1100px] mx-auto">
            ...
            <div className="flex gap-2.5 mt-5">
              {SOCIALS.map((s) => (
                <a
                  key={s}
                  href="#"
                  className="w-[34px] h-[34px] bg-gray-50 border border-gray-200 flex items-center justify-center font-sans text-[11px] font-bold text-gray-500 hover:bg-[#053DCA] hover:text-white transition-all rounded-sm"
                >
                  {s}
                </a>
              ))}
        ...
        {/* Bottom bar */}
        <div className="border-t border-gray-200 pt-5 flex flex-col md:flex-row justify-between items-center gap-3">
          <p className="font-sans text-[11px] text-gray-400">
            © 2026 Agrawal Business Community, Indore. All rights reserved.
          </p>
          <p className="font-sans text-[11px] text-[#053DCA] tracking-[0.15em] uppercase">
            Arth · Neeti · Dharma
          </p>
        </div>
      </div>
